...
public class FinancialController {
    ...
    public ResponseEntity<TetherAccountAndDepositDTO> createOrFindTetherAccount(@RequestBody TetherCreateDTO tetherCreateDTO) {
    ...
    public ResponseEntity<TetherDeposit> createTetherDeposit(@RequestBody TetherDepositRequestDTO tetherDepositRequestDTO) {
    ...
    public ResponseEntity<TetherDepositDTO> getLatestDepositByWallet(@PathVariable String tetherWallet) {
