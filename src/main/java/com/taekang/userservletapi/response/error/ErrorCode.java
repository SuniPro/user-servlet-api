...
public enum ErrorCode {
  USER_CREATE_FAIL(400, "USER_CREATE_FAIL", "유저 생성을 실패했습니다."),

  USER_UPDATE_FAIL(400, "USER_UPDATE_FAIL", "유저 업데이트를 실패했습니다."),

  USER_DELETE_FAIL(400, "USER_DELETE_FAIL", "유저 삭제를 실패했습니다."),
